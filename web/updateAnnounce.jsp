<%@ page import="OCP.vo.announce" import="java.util.List" import="OCP.factory.DAOFactory" %><%--
        ...
        <div id="main_content">
            ...
            <div id="main_right">
                <%
                    ...
                    List<announce> list= DAOFactory.getAnnounceDAOInstance().queryAll(announce_title);
                %>
                <h1>发布公告</h1>
                <form action="updateAnnounceServlet" method="post">
                    <h2>公告标题:</h2>
                    <input type="text" name="announce_title" style="margin-left: 105px;" value="<%=list.get(0).getAnnounce_title()%>">
                    <h2>公告内容：</h2>
                    <textarea name="announce_content" maxlength="200" style="margin-left: 105px;"><%=list.get(0).getAnnounce_content()%></textarea>
                    <p class="extra-tips">还可以输入 <span id="tipsNum">200</span> 字</p>
                    <h2>发布时间：</h2>
                    <input type="text" name="announce_date" style="margin-left: 105px;" value="<%=list.get(0).getAnnounce_date()%>">
