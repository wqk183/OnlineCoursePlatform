            ...
            <div id="main_right">
                ...
                <table border="1px" width="760px">
                    ...
                    <tr>
                        ...
                        <td><a href="deleteServlet?id=<%=per.getId()%>">删除</a></td>
                    </tr>
                    <%}  %>
                    <tr>
                        <td colspan="13" align="right">
                            <a href="deleteManagement.jsp?flag=<%=SplitPage.FIRSTPAGE%>">首页</a>
                            <a href="deleteManagement.jsp?flag=<%=SplitPage.PREVIOUSEPAGE %>">上一页</a>
                            <a href="deleteManagement.jsp?flag=<%=SplitPage.NEXTPAGE %>">下一页</a>
                            <a href="deleteManagement.jsp?flag=<%=SplitPage.LASTPAGE %>">最后页</a>
