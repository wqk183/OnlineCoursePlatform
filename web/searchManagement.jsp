...
<head>
    ...
    <link rel="stylesheet" href="css/searchManagement_style.css">
        ...
        <div id="main_content">
            ...
            <div id="main_right">
                <form action="" method="post">
                    在<select name="item">
                    <option value="account" checked>账号</option>
                    <option value="name">姓名</option>
                </select>中查询：<input type="text" name="content"><input type="submit" name="submit" value="搜索">
                </form>
                <%
                ...
                <table border="1px" width="760px">
                    <thead>
                    <th>id</th><th>账号</th><th>密码</th><th>头像</th><th>姓名</th><th>性别</th><th>年龄</th><th>地址</th><th>简介</th><th>职业状态</th><th>职业方向</th><th>身份</th>
                    </thead>
                    ...
                    <tr>
                        <td colspan="12" align="right">
                            <a href="searchManagement.jsp?flag=<%=SplitPage.FIRSTPAGE%>&item=<%=strItem%>&content=<%=strContent%>">首页</a>
                            <a href="searchManagement.jsp?flag=<%=SplitPage.PREVIOUSEPAGE%>&item=<%=strItem%>&content=<%=strContent%>">上一页</a>
                            <a href="searchManagement.jsp?flag=<%=SplitPage.NEXTPAGE %>&item=<%=strItem%>&content=<%=strContent%>">下一页</a>
                            <a href="searchManagement.jsp?flag=<%=SplitPage.LASTPAGE %>&item=<%=strItem%>&content=<%=strContent%>">最后页</a>
