            ...
            <div id="main_video">
                <ul>
                    <li>
                        <a href="video1.jsp">
                            <div class="courseBox" >
                                <div class="imgBox"><img src="img/f1.jpg" alt=""></div>
                                <div class="infoBox"><p>大数据 Hadoop 离线分布式系统入门</p></div>
                            </div>
                        </a>
                    </li>
                    <li>
                    <li>
                        <a href="video2.jsp">
                            <div class="courseBox" >
                                <div class="imgBox"><img src="img/f2.jpg" alt=""></div>
                                <div class="infoBox"><p>PHP+MySQL二级考试</p></div>
                            </div>
                        </a>
                    </li>
                    </li>
                    ...
                    <li>
                        <a href="video3.jsp">
                            <div class="courseBox" >
                                <div class="imgBox"><img src="img/f3.jpg" alt=""></div>
                                <div class="infoBox"><p>JDBC视频教程</p></div>
                            </div>
                        </a>
                    </li>
                    </li>
                    ...
                    <li>
                        <a href="video4.jsp">
                            <div class="courseBox" >
                                <div class="imgBox"><img src="img/f4.jpg" alt=""></div>
                                <div class="infoBox"><p>基于struts2拦截器实现数据和视图的分离</p></div>
                            </div>
                        </a>
                    </li>
                    </li>
                    ...
                    <li>
                        <a href="video5.jsp">
                            <div class="courseBox" >
                                <div class="imgBox"><img src="img/f5.png" alt=""></div>
                                <div class="infoBox"><p>（懂中文就能学会）Python入门教程</p></div>
                            </div>
                        </a>
                    </li>
                    </li>
                    ...
                    <li>
                        <a href="video6.jsp">
                            <div class="courseBox" >
                                <div class="imgBox"><img src="img/f6.jpg" alt=""></div>
                                <div class="infoBox"><p>H5+全栈入门教程</p></div>
                            </div>
                        </a>
                    </li>
                    </li>
                    ...
                    <li>
                        <a href="video8.jsp">
                            <div class="courseBox" >
                                <div class="imgBox"><img src="img/f8.jpg" alt=""></div>
                                <div class="infoBox"><p>玩转Github开发</p></div>
                            </div>
                        </a>
                    </li>
                    </li>
                    ...
                    <li>
                        <a href="video9.jsp">
                            <div class="courseBox" >
                                <div class="imgBox"><img src="img/f9.jpg" alt=""></div>
                                <div class="infoBox"><p>Android手机卫士</p></div>
                            </div>
                        </a>
                    </li>
                    </li>
                    ...
                    <li>
                        <a href="video10.jsp">
                            <div class="courseBox" >
                                <div class="imgBox"><img src="img/f10.jpg" alt=""></div>
                                <div class="infoBox"><p>搜索引擎优化教程</p></div>
                            </div>
                        </a>
                    </li>
                    </li>
                    ...
                    <li>
                        <a href="video11.jsp">
                            <div class="courseBox" >
                                <div class="imgBox"><img src="img/f11.jpg" alt=""></div>
                                <div class="infoBox"><p>不敲代码免费教你制作APP</p></div>
                            </div>
                        </a>
                    </li>
                    </li>
                    ...
                    <li>
                        <a href="video12.jsp">
                            <div class="courseBox" >
                                <div class="imgBox"><img src="img/f12.jpg" alt=""></div>
                                <div class="infoBox"><p>C++基础视频教程-适合新手自学</p></div>
                            </div>
                        </a>
                    </li>
                    </li>
