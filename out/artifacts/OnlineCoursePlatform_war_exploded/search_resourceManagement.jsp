        ...
        <div id="main_content">
            ...
            <div id="main_right">
                <form action="" method="post">
                    在<select name="item">
                    <option value="id" checked>编号</option>
                    <option value="video_name">视频名称</option>
                ...
                <table border="1px" width="760px">
                    <thead>
                    <th>id</th><th>视频名称</th><th>视频路径</th>
                    </thead>
                    ...
                    <tr>
                        <td colspan="4" align="right">
                            <a href="update_resourceManagement.jsp?flag=<%=SplitPage.FIRSTPAGE%>&item=<%=strItem%>&content=<%=strContent%>">首页</a>
                            <a href="update_resourceManagement.jsp?flag=<%=SplitPage.PREVIOUSEPAGE %>&item=<%=strItem%>&content=<%=strContent%>">上一页</a>
                            <a href="update_resourceManagement.jsp?flag=<%=SplitPage.NEXTPAGE %>&item=<%=strItem%>&content=<%=strContent%>">下一页</a>
                            <a href="update_resourceManagement.jsp?flag=<%=SplitPage.LASTPAGE %>&item=<%=strItem%>&content=<%=strContent%>">最后页</a>
