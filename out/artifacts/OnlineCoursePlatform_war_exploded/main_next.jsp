                    ...
                    <div class="carousel slide" id="carousel-180347" >
                        ...
                        <div class="carousel-inner" style="padding-left:0px;width: 1366px;height: 360px">
                            <div class="carousel-item active">
                                <img class="d-block w-100" alt="Carousel Bootstrap First" src="img/z3.jpg"/>
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" alt="Carousel Bootstrap Second" src="img/z4.jpg" />
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" alt="Carousel Bootstrap Third" src="img/z5.jpg" />
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" alt="Carousel Bootstrap Third" src="img/z6.jpg" />
                            </div>
